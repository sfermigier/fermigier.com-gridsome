<template>
  <Layout>
    ...
    <div class="container-inner mx-auto content text-lg sm:text-xl">
      <p>My name is Stefane Fermigier, I'm a tech entrepreneur.</p>

      <p>I'm the founder and CEO of <a href="https://abilian.com/">Abilian</a>, a company which develops enterprise information management solutions based on open source software.</p>

      <p>
        Previously, I founded <a href="http://www.nuxeo.com/">Nuxeo</a> in 2000, and served as its CEO from 2000 to 2008, then as
        its executive chairman from 2008 to 2011.
        Nuxeo is now one of the largest open source software vendors in France.</p>

      <p>I've also cofounded and led several organizations dedicated to developing the open source ecosystem in France and Europe:</p>

      <ul>
        <li><a href="http://www.aful.org/">AFUL</a>, the french-speaking Linux and free software users association. I
          served as it president from 1998 to 2003.
        </li>
        <li><b>GTLL</b>, the business and innovation cluster for open source
          in the Paris Region (part of the Systematic Paris Region cluster). I've bee serving as its president since
          2009.
        </li>
        <li><b>EuroLinux</b>.</li>
        <li>The <a href="http://www.opensourcesummit.paris/">Open World Forum / Paris Open Source Summit</a>, yearly conference dedicated to open
          source and "open everything" in Paris (since 2008).
        </li>
      </ul>

      <p>I'm also the founder or a cofounder of several open source projects:</p>

      <ul>
        <li><a href="https://github.com/abilian/abilian-sbe">Abilian SBE</a></li>
        <li><a href="https://github.com/abilian/olapy">Olapy</a></li>
        <li><a href="http://incubator.apache.org/stanbol/">Apache Stanbol</a></li>
        <li><a href="http://chemistry.apache.org/">Apache Chemistry</a></li>
      </ul>

      <p>
        I also have a few personal project on <a href="https://github.com/sfermigier">GitHub</a>.
      </p>
