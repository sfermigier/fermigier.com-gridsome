<template>
  <Layout>
    ...
    <div class="container-inner mx-auto content text-lg sm:text-xl">
      ...
      <p>
        I'm the founder and CEO of <a href="https://abilian.com/">Abilian</a>, a
        company which develops enterprise information management solutions based
        on open source software.
      </p>

      <p>
        Previously, I founded <a href="http://www.nuxeo.com/">Nuxeo</a> in 2000,
      ...
      <p>
        I've also cofounded and led several organizations dedicated to
        developing the open source ecosystem in France and Europe:
      </p>

      <ul>
        <li>
          <a href="http://www.aful.org/">AFUL</a>, the french-speaking Linux and
          free software users association. I served as it president from 1998 to
          2003.
        </li>
        <li>
          <b>GTLL</b>, the business and innovation cluster for open source in
          the Paris Region (part of the Systematic Paris Region cluster). I've
          bee serving as its president since 2009.
        </li>
        <li><b>EuroLinux</b>.</li>
        <li>
          The
          <a href="http://www.opensourcesummit.paris/"
            >Open World Forum / Paris Open Source Summit</a
          >, yearly conference dedicated to open source and "open everything" in
          Paris (since 2008).
        </li>
      </ul>

      <p>
        I'm also the founder or a cofounder of several open source projects:
      </p>

      <ul>
        <li>
          <a href="https://github.com/abilian/abilian-sbe">Abilian SBE</a>
        </li>
